 ...
 * read_revisions.c
 * 
 * Example program to read the bit values of Semtech i2c GPIO port expander
 * pins on the MistySOM and MistySOM Carrier to determine the board revisions
 * of the SOM and carrier boards
 * 
 * This example is adapted from sample code tutorial for
 * "Control GPIO using the new Linux user space GPIO API" 
 * by Dany Le found at https://blog.lxsang.me/post/id/33#
 *
 * Copyright (c) 2023  MistyWest Design and Engineering, Inc.
 * 
 */
