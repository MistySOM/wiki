...
script is used to toggle the LED on and off 3 times at 1-second intervals.  For testing other GPIO signals on the J4 header, the jumper should be reconnected to the desired GPIO header pin, and the corresponding [gpio_J4_pin_NN_toggle.sh](../files/gpio/) should be invoked from the command line. 
